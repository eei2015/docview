...
//            if (!_instance) {
//                //_instance = [self new];
//                _instance = [[MessageBoard alloc] init];
//            }
//        }
...
{
    SNSCreateTopicRequest *ctr = [[[SNSCreateTopicRequest alloc] initWithName:@"Test Topic"] autorelease];
    ...
    SNSSetTopicAttributesRequest *st = [[[SNSSetTopicAttributesRequest alloc] initWithTopicArn:response.topicArn andAttributeName:@"DisplayName" andAttributeValue:@"Test Topic"] autorelease];
...
//    }
    ...
    snsClient = [[AmazonSNSClient alloc] initWithAccessKey:@"AKIAJC2D63XQ2KLEB3ZA" withSecretKey:@"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"];
    snsClient.endpoint = [AmazonEndpoints snsEndpoint:US_WEST_2];
    
    SNSCreatePlatformEndpointRequest *endpointReq = [[SNSCreatePlatformEndpointRequest alloc] init];
    endpointReq.platformApplicationArn = @"arn:aws:sns:us-west-2:772930350700:app/APNS/Amazon_SNS_Demo_Local";
    //[[Content shared] AmazonApplicationARN];
    endpointReq.token = @"a9b83371274009d7c6f1215ff4e36a9689ff9f54fb36b8f267cc1362b45333d8";
...
-(bool)pushToMobile:(NSString*)theMessage
{
    ...
    [d setObject:@"Vipul" forKey:@"FirstName"];
    [d setObject:@"Patel" forKey:@"LastName"];
    [d setObject:theMessage forKey:@"Message"];
...
{
    SQSCreateQueueRequest *cqr = [[[SQSCreateQueueRequest alloc] initWithQueueName:@"Test Queue"] autorelease];
...
{
    NSString *topicNameToFind = [NSString stringWithFormat:@":%@", @"Test Topic"];
...
{
    NSString *queueNameToFind = [NSString stringWithFormat:@"/%@", @"Test Queue"];
