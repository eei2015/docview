...
- (void) TSAlertView_commonInit
{
	...
	self.width = 0; // set to default   // 550  -  Jatin Chauhan 28-Nov-2013
	self.maxHeight = 0; // set to default   // 600  -  Jatin Chauhan 28-Nov-2013
...
- (UILabel*) titleLabel
{
	if ( _titleLabel == nil )
	{
		...
		_titleLabel.font = [UIFont boldSystemFontOfSize: 20];// 40 - Jatin Chauhan 28-Nov-2013
...
- (UILabel*) messageLabel
{
	if ( _messageLabel == nil )
	{
		...
		_messageLabel.font = [UIFont systemFontOfSize: 20];// 40 - Jatin Chauhan 28-Nov-2013
...
- (UITextView*) messageTextView
{
	if ( _messageTextView == nil )
	{
		...
		_messageTextView.font = [UIFont systemFontOfSize: 16];// 32 - Jatin Chauhan 28-Nov-2013		_messageTextView.backgroundColor = [UIColor whiteColor];
...
- (UIImage*) backgroundImage
{
	...
	{
		self.backgroundImage = [[UIImage imageNamed: @"TSAlertViewBackground.png"] stretchableImageWithLeftCapWidth: 15 topCapHeight: 30];//LeftCapWidth: 15 topCapHeight: 30]
	}
...
- (NSInteger) addButtonWithTitle: (NSString *) t
{
	...
	b.titleLabel.font = [UIFont boldSystemFontOfSize:18];//36 Jatin 28-Nov-2013
...
- (CGSize) recalcSizeAndLayout: (BOOL) layout
{
	...
	CGFloat totalHeight = kTSAlertView_TopMargin + titleLabelSize.height + kTSAlertView_RowMargin + messageViewSize.height + inputRowHeight + (kTSAlertView_RowMargin * 2) + buttonsAreaSize.height + kTSAlertView_BottomMargin;
